...
/* build_config.h - Zephyr shim over the SDK wpa supplicant build config.
 ...
 * rejected by the AP instead of crashing the supplicant.  (The driver
 * also refuses SAE-only networks up front with -ENOTSUP -- see
 * gdwifi_drv.c.)
 */

#undef CONFIG_WPA3_SAE

/* The CAU/HAU engines belong to the Zephyr crypto drivers */
#undef WPA_HW_SECURITY_ENGINE_ENABLE
