/****************************************************************************
 * drivers/wifi/gdwifi/gdwifi_newlib_compat.c
 *
 ...
 * not include any libc header (errno is a macro there).
 *
...
/* Private errno cell for the prebuilt library (not shared with the C library's
