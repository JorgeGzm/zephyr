...
/*
 * The cases shared by every driver use the first variant the driver
 * supports; the expected values are the CRC of each case's data under it.
 */
...
#elif defined(CONFIG_CRC_DRIVER_HAS_CRC32_C)
